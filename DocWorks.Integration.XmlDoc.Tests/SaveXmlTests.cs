...
"
        ...
        public void ImportDocumentation_ShouldUpdateSuccessfully()
        {
            ...
            try
            {
                var handler = new XMLDocHandler(new CompilationParameters(Path.GetDirectoryName(sourcePath), new string[0], new string[] { "Win64", "MacOs" }, new string[0], new string[0]));
